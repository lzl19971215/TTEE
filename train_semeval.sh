...
TASK_NAME="ttee_${PRETRAIN_MODEL_NAME}_${DATASET}_${EPOCH}epoch_512d_${N_AUG}aug_${LR}lr_5000decaystep_0.90decayrate_0.2dropout_0.2detect_dropout_1loss_BIO_${DETECT_LOSS}_no_asp_batch_${FUSE_STRATEGY}_${OUT_ACT}outact_${IN_ACT}inact"
echo ${TASK_NAME}
echo ${SAVE_DIR}
python train.py \
    --do_train \
